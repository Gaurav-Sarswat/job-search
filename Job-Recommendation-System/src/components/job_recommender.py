...
# Load dataset:
jd_df=pd.read_csv(r'/Users/SAM/Downloads/job-search/Job-Recommendation-System/src/data/jd_structured_data.csv')

# Load the extracted resume skills:
file_path=r'/Users/SAM/Downloads/job-search/Job-Recommendation-System/utilities/resumes/CV.pdf'
skills=[]
